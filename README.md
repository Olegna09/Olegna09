...
| Project | Description |
|----------|------------|
| <a href="https://github.com/Olegna09/entra-id-identity-governance-lab">Enterprise Identity Governance Lab – Microsoft Entra ID</a> | Designing and testing risk-based access policies |
